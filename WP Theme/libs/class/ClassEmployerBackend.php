...
class Employer_List extends WP_List_Table
{
    ...
    function __construct()
    {
        ...
        foreach ($result as $key => $value) {
            $strEdit = '<a href="?page=employer-list&employer-edit=true&id=' . $value->ID . '">Edit</a> |
...
//            'passport_no' => __('Passport', 'mylisttable'),
    ...
    function employerAddTemplate()
    {
        ...
        ?>
        </pre><div class="wrap"><h2><?php echo $isEdit? "Edit": "Add New"; ?> Employer</h2>
    ...
    bloginfo('template_directory'); ?>/libs/images/loading.gif" width="40"/></div>';
        ...
        <div class="form-group col-md-12" style="">
            ...
            <a type="button" id="btn_success" style="display: <?php echo $userID ? 'block': 'none'?>;" class="btn btn-success pull-right"
               href="?page=employer-list">Finish </a>
            <button type="submit" id="btn_submit" class="btn btn-primary pull-right">Submit </button>
