...
function my_custom_submenu_page_callback(){
	...
	?>
    <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/libs/css/bootstrap.min.css">
    ...
    <style type="text/css">
		li.pagelist{width:150px;height:150px; border:1px #eee solid; background:#fff; float:left; margin:10px 10px 0 0; text-align:center}li.pagelist h4{padding:0}.clear{clear:both}
	</style>
