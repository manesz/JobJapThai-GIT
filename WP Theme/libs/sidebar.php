<aside class="col-md-4" style="">
    ...
    <?php include_once("pages/box-signin.php"); ?>
    ...
    <div class="clearfix" style="<?php if (isset($page) && $page == "news"): echo "display: none; ";
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="active col-md-6 text-center" style="list-style: none; border: none;"><a href="#search" role="tab"
                                                                                               data-toggle="tab">Search</a>
            </li>
            <li class="col-md-6 text-center" style="list-style: none; border: none;"><a href="#advanceSearch" role="tab"
            ...
            <div class="tab-pane" id="advanceSearch">
                <form action="<?php echo esc_url(home_url('/')); ?>" method="get">
                    ...
                    <div class="form-group clearfix" style="margin-bottom: 10px;">
                        ...
                        <select name="location" class="col-md-12 form-control">
                    ...
                    <div class="form-group clearfix" style="margin-bottom: 10px;">
                        ...
                        <select name="type" class="col-md-12 form-control">
                    ...
                    <div class="form-group clearfix" style="margin-bottom: 10px;">
                        ...
                        <select name="subCategory" class="col-md-12 form-control">
        ...
        <ul class="job-list no-padding margin-top-10">
            <?php for ($i = 0; $i <= 4; $i++): ?>
                <li class="clearfix border-bottom-1-ddd padding-top-10 padding-bottom-10">
                    <div class="col-md-12">
                        <div class="col-md-4" style="padding: 0px"><img
