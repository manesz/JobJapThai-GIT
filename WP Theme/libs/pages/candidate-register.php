        ...
        <div class="container wrapper">
            <div class="row">
                ...
                <?php if ( is_user_logged_in() ) {?>
                    ...
                    <div class="btn-group">
                    <a href="#" class="btn btn-default">Edit Resume</a>
                    ...
                    <a href="#" class="btn btn-default active">Account Setting</a>
                    </div>
                        ...
                        <div class="col-md-4" style="padding-top: 10px;">
                            <img src="<?php echo get_template_directory_uri(); ?>/libs/img/blank-logo.png" class="img-circle" style="width: 100px; height: 100px;"/>
