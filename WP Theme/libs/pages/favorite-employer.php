                ...
                <div class="clearfix"
                    ...
                    <h5 class="pull-left" style="">
                        <img src="<?php echo get_template_directory_uri(); ?>/libs/img/icon-title.png"
                             style="height: 25px;"/>
                        お知らせ
                        <span class="font-color-BF2026" style="">Favorite Employer</span>
                    </h5>
                    ...
                    <hr/>
                    <h5 class="font-color-BF2026">Favorite Employer List</h5>
...
//                        ?>
                    ...
                    <?php
                    $argc = $classQueryPostJob->queryFavoriteEmployer($userID);
                    echo $classQueryPostJob->buildListEmployer($argc);
                    ?>
                </div>
